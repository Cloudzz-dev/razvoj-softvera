                ...
                <div className="flex gap-2">
                    {(["all", "sent", "received"] as TransactionFilter[]).map((f) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filter === f ? "bg-indigo-600 text-white" : "bg-white/5 text-zinc-400 hover:bg-white/10"}`}
                        >
            ...
            <div className="space-y-3">
                {isLoading ? (
                    ...
                    transactions.map((tx) => {
                        ...
                        return (
                            <div key={tx.id} className="p-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group">
                                    ...
                                    <div className="flex items-start gap-3 flex-1">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className={`px-2 py-0.5 rounded text-xs font-medium ${statusColor === "green" ? "bg-green-500/20 text-green-400" : statusColor === "yellow" ? "bg-yellow-500/20 text-yellow-400" : statusColor === "red" ? "bg-red-500/20 text-red-400" : "bg-gray-500/20 text-gray-400"}`}>
